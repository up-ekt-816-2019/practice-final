...
so $ATT = 0.5625 - 0.375 = 0.1875$. Notice, by the way, that $E[Y|D = 0] = 0$, so the naive difference in means is 0.5625, much larger than the ATT and the wrong sign compared to the ATE of -0.05.
